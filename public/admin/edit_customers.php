                ...
                <div class="container-fluid">
                    ...
                    <section class="">
                        <div class="container text-center">
                            <h2 class="position-relative d-inline-block">Thông tin khách hàng</h2>
                        </div>
                        ...
                        <div class="mx-auto container">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    $select_customers = $pdo->prepare("SELECT * FROM `user` WHERE id = ?");
                                    $select_customers->execute([$update_id]);
                                    if ($select_customers->rowCount() > 0) {
                                        while ($fetch_customers = $select_customers->fetch(PDO::FETCH_ASSOC)) {
                                            ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input class="form-control w-100" type="hidden" name="old_image"
                                                                value="<?= htmlspecialchars($fetch_customers['image']); ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <input class="form-control" type="hidden" name="id"
                                                                value="<?= htmlspecialchars($fetch_customers['id']); ?>">
                                                        </div>

                                                        <div class="form-group text-center">
                                                            <?php if ($fetch_customers['image'] == '') {
                                                                echo '<img class="img-fluid" src="../img/account/user0.png" alt="" width="315px" height="315px" />';
                                                            } else {
                                                                ?>
                                                                <img class="img-fluid"
                                                                    src="uploaded_img/user/<?= htmlspecialchars($fetch_customers['image']); ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <select name="sex" class="form-control" required>
                                                                ...
                                                                <?php
                                                                $sex = htmlspecialchars($fetch_customers['sex']);
                                                        ...
                                                        <div class="form-group">
                                                            <textarea class="form-control" name="address" required
                                                                ...
                                                                rows="2"><?= htmlspecialchars($fetch_customers['address']); ?></textarea>
                                                        </div>
